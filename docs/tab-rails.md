Panels can dock to either the top or bottom tab rail. Both rails sit flush against the screen edge, with a 7px left margin, 6px right margin and inter-tab spacing, and independent horizontal scrolling. Drag a title bar near either screen edge to dock it, between tabs to reorder it, or away from the rails to float it.
