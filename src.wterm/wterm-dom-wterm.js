import { Renderer } from "./wterm-dom-renderer.js";
import { InputHandler } from "./wterm-dom-input.js";
...
export class WTerm {
    ...
    async init() {
        try {
            if (!this._coreOption) throw new Error("wterm: a screen core is required");
