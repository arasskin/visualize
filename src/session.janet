# The session: owning a live pty, and answering for it over a socket.
#
# THIS FILE IS THE SUPERVISOR PROCESS. `visualize --supervise` starts it
# and it outlives the server. A pty's master fd belongs to the process that
...
# send, resize, redraw, state, since, poll, shutdown -- is in ./harness.janet.
...
# -- the wire ----------------------------------------------------------------
# This side of the protocol. The other side is in ./harness.janet.
